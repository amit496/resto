...
<head>
    ...
    <title>{{ config('app.name', 'FoodiHub') }} Reset Password</title>
...
<body>
    <div class="auth-shell">
        <section class="auth-copy">
            ...
            <h1>Set a fresh password in seconds.</h1>
            <p>Create a new password to securely access your customer dashboard.</p>
            <div class="chip-row">
                <div class="chip">Secure</div>
                <div class="chip">Fast Reset</div>
                <div class="chip">Customer First</div>
            </div>
        </section>
            ...
            <div class="phone-screen">
                <div class="screen-brand">
                    ...
                    <div>
                        ...
                        <div style="color:rgba(255,255,255,0.72);font-size:12px;">Reset Password</div>
                    </div>
                </div>
                ...
                <p class="screen-copy">Use a strong password for future logins.</p>
                ...
                <div class="auth-card">
                    ...
                    <form method="POST" action="{{ route('customer.password.store') }}">
                        ...
                        <div class="input-shell">
                            ...
                            <input id="email" class="auth-input" type="email" name="email" value="{{ old('email', request('email')) }}" required autofocus placeholder="Email Address">
                        </div>
                        <div class="input-shell">
                            <span class="input-icon">*</span>
