...
<head>
    ...
    <title>{{ config('app.name', 'FoodiHub') }} Customer Register</title>
...
<body>
    <div class="auth-shell">
        <section class="auth-copy">
            ...
            <h1>Create your FoodiHub customer account.</h1>
            <p>Register once to save your delivery details, unlock loyalty points and leave branch reviews.</p>
            <div class="chip-row">
                <div class="chip">Fast Checkout</div>
                <div class="chip">Loyalty Rewards</div>
                <div class="chip">Order History</div>
            </div>
        </section>
            ...
            <div class="phone-screen">
                <div class="screen-brand">
                    ...
                    <div>
                        ...
                        <div style="color:rgba(255,255,255,0.72);font-size:12px;">Customer Registration</div>
                    </div>
                </div>

                <div class="kicker">Join FoodiHub</div>
                <h2 style="margin:0 0 8px;font-family:'Outfit',sans-serif;font-size:44px;letter-spacing:-0.05em;line-height:0.92;">Create account</h2>
                <p class="screen-copy">Get personalized offers, easy reorders and branch updates.</p>
                ...
                <div class="auth-card">
                    ...
                    <form method="POST" action="{{ route('customer.register.store') }}">
                        ...
                        <div class="input-shell">
                            ...
                            <input id="name" class="auth-input" type="text" name="name" value="{{ old('name') }}" required autofocus placeholder="Full Name">
                        </div>
                        <div class="input-shell">
                            <span class="input-icon">@</span>
                            <input id="email" class="auth-input" type="email" name="email" value="{{ old('email') }}" required placeholder="Email Address">
                        </div>
                        <div class="input-shell">
                            <span class="input-icon">#</span>
                            <input id="phone" class="auth-input" type="text" name="phone" value="{{ old('phone') }}" placeholder="Phone (optional)">
                        </div>
                        <div class="input-shell">
                            <span class="input-icon">*</span>
