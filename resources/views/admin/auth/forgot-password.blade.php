...
<head>
    ...
    <title>{{ config('app.name', 'FoodiHub') }} Admin Password Reset</title>
    ...
    <style>
        ...
        *{box-sizing:border-box}
        ...
        .status-box{background:#ecfbf1;color:#1b6a34}
        .error-box{background:#ffe9e6;color:#9b2e1b}
...
<body>
    <div class="auth-shell">
        <section class="auth-copy">
            ...
            <p>We will send a secure link so you can access the admin dashboard.</p>
            <div class="chip-row">
            ...
            <div class="phone-screen">
                <div class="screen-brand">
                    ...
                    <div>
                        ...
                        <div style="color:rgba(255,255,255,0.72);font-size:12px;">Admin Password Reset</div>
                    </div>
                </div>
                ...
                <p class="screen-copy">Enter your admin email to receive a reset link.</p>
                ...
                <div class="auth-card">
                    ...
                    <form method="POST" action="{{ route('admin.password.email') }}">
                        ...
                        <div class="input-shell">
                            ...
                            <input id="email" class="auth-input" type="email" name="email" value="{{ old('email') }}" required autofocus placeholder="Admin Email">
                        </div>
