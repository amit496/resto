...
<head>
    ...
    <title>{{ config('app.name', 'FoodiHub') }} Confirm Password</title>
...
<body>
    <div class="auth-shell">
        <section class="auth-copy">
            ...
            <h1>Confirm your password to continue.</h1>
            <p>This keeps your admin actions secure and verified.</p>
            <div class="chip-row">
            ...
            <div class="phone-screen">
                <div class="screen-brand">
                    ...
                    <div>
                        ...
                        <div style="color:rgba(255,255,255,0.72);font-size:12px;">Confirm Password</div>
                    </div>
                </div>

                <div class="kicker">Security Check</div>
                <h2 style="margin:0 0 8px;font-family:'Outfit',sans-serif;font-size:44px;letter-spacing:-0.05em;line-height:0.92;">Confirm password</h2>
                <p class="screen-copy">Please enter your password to proceed.</p>
                ...
                <div class="screen-foot">
                    This keeps your admin actions secure.
                </div>
            </div>
        </section>
    </div>
