...
<head>
    ...
    <title>{{ config('app.name', 'FoodiHub') }} Admin Register</title>
...
<body>
    <div class="auth-shell">
        <section class="auth-copy">
            ...
            <h1>Create an admin account for FoodiHub.</h1>
            <p>Register to manage branches, orders, and staff insights.</p>
            <div class="chip-row">
                <div class="chip">Admin Console</div>
                <div class="chip">Branch Control</div>
            ...
            <div class="phone-screen">
                <div class="screen-brand">
                    ...
                    <div>
                        ...
                        <div style="color:rgba(255,255,255,0.72);font-size:12px;">Admin Registration</div>
                    </div>
                </div>

                <div class="kicker">Welcome Admin</div>
                ...
                <p class="screen-copy">Set up your admin access in one step.</p>
                ...
                <div class="auth-card">
                    ...
                    <form method="POST" action="{{ route('admin.store-register') }}">
                        @csrf
                    ...
                    <div class="secondary-links">
                        Already have access? <a href="{{ route('admin.login') }}">Login</a>
                    </div>
                </div>
