...
<head>
    ...
    <title>{{ config('app.name', 'FoodiHub') }} Verify Admin Email</title>
...
<body>
    <div class="auth-shell">
        <section class="auth-copy">
            ...
            <p>We have emailed a verification link to secure your admin account.</p>
            <div class="chip-row">
                <div class="chip">Secure Access</div>
            ...
            <div class="phone-screen">
                <div class="screen-brand">
                    ...
                    <div>
                        ...
                        <div style="color:rgba(255,255,255,0.72);font-size:12px;">Verify Admin Email</div>
                    </div>
                </div>
                ...
                <p class="screen-copy">Check your inbox and verify to continue.</p>
                ...
                <div class="screen-foot">
                    If you did not receive the email, check spam or resend.
                </div>
            </div>
        </section>
    </div>
